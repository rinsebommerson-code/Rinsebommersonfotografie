    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pb-24 pt-40 md:pb-32 md:pt-48">
        <div className="max-w-3xl">
          ...
          >
            Je reis als ondernemer heeft je laten groeien tot wie je nu bent. Het wordt tijd dat jouw foto&apos;s dat ook gaan laten zien. Je bedrijf groeit, dat vraagt om visuele strategie niet losse fotoshoots.
          </motion.p>
