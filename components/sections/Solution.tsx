...
const steps = [
  ...
  },
  {
    ...
    body: "Op basis van het gesprek werken we een volledig concept uit: welke beelden, welke sfeer, welke verhalen je foto's moeten vertellen.",
  },
  {
    number: "03",
    title: "Styling, locatie & haar/make-up",
    subtitle: "Wij regelen alles",
    body: "Van de juiste locatie scouten tot styling-advies en een professionele haar & make-up artiest — wij coördineren alles.",
  },
  {
    number: "04",
    title: "De shoot zelf",
    subtitle: "Jij in je element",
    body: "Een ontspannen, goed geregisseerde dag (of dagdeel) waar we werken volgens het plan. Je voelt je op je gemak en het resultaat spreekt voor zich.",
  },
  {
    number: "05",
    title: "Beeldredactie & levering",
    subtitle: "Klaar om te gebruiken",
    body: "Professionele nabewerking van alle geselecteerde beelden. Geleverd in meerdere formaten — klaar voor website, LinkedIn, social media. Voor jaren.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            ...
            strategie tot levering. Alles geregeld, niets overgelaten aan het toeval.
          </motion.p>
        </div>

        {/* ── Steps + side photos ── */}
        <div className="flex gap-8 lg:gap-16 items-start mb-16">
          {/* Steps list */}
          <div className="flex-1 min-w-0 space-y-px">
            {steps.map((step, i) => (
              <motion.div
                ...
                className="flex gap-6 md:gap-10 p-6 md:p-8 border-b"
                style={{ borderColor: "rgba(250,248,245,0.08)" }}
              >
                <div
                  className="text-4xl font-light shrink-0 w-12 md:w-16 leading-none pt-1"
                  style={{ fontFamily: "var(--font-playfair)", color: "rgba(184,146,106,0.3)" }}
                >
                  {step.number}
                </div>
                <div className="flex-1">
                  ...
                  <p
                    ...
                    style={{ color: "rgba(250,248,245,0.6)", fontFamily: "var(--font-dm-sans)", fontWeight: 300 }}
                  >
                    {step.body}
                  </p>
                </div>
          ...
          <div className="hidden lg:flex flex-col gap-4 shrink-0 w-56 pt-4">
        ...
        >
          ...
          >
            Standaard al veel inbegrepen — voor maatwerk voeg je toe wat bij jouw situatie past.
          </p>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
            {addons.map((addon, i) => (
              ...
              >
                ...
                <div>
                  <div className="text-sm font-medium" style={{ color: "var(--cream)", fontFamily: "var(--font-dm-sans)" }}>{addon.label}</div>
                  <div className="text-xs mt-0.5" style={{ color: "rgba(250,248,245,0.5)", fontFamily: "var(--font-dm-sans)" }}>{addon.desc}</div>
                </div>
              </div>
            ))}
          </div>
